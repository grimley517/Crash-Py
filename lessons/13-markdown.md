...
> **Download:** [markdown_example.md]({{ site.baseurl }}/resources/lesson-05/markdown_example.md)
...
[← Lesson 12]({{ site.baseurl }}/lessons/12-excel-files/)
[Next Lesson: Version Control with Git →]({{ site.baseurl }}/lessons/14-git/)
