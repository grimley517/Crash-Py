...
> **Download:** [decisions.py]({{ site.baseurl }}/resources/lesson-05/decisions.py)
...
5. Can you write a `grade()` function using a *dictionary* instead of
   `if … elif`?  (Hint: this is tricky — come back to it after Lesson 10.)

---

[← Lesson 7]({{ site.baseurl }}/lessons/07-lists/)
[Next Lesson: For Loops with Range →]({{ site.baseurl }}/lessons/09-for-loops/)
